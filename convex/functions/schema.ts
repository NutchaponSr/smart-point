...
export const employee = convexTable(
  "employee",
  {
...
export const wallet = convexTable(
  "wallet",
  {
    employeeId: id("employee").notNull(),
    ...
    loginStreak: integer(),
    praiseStreakMonths: integer(),
  },
  (t) => [index("by_employeeId").on(t.employeeId)],
);

export const transaction = convexTable(
  "transaction",
  {
...
export const like = convexTable(
  ...
  (t) => [
    ...
    uniqueIndex("by_employeeId_transactionId").on(
      t.employeeId,
      t.transactionId,
    ),
  ],
...
export const comment = convexTable(
  "comment",
  {
    employeeId: id("employee").notNull(),
    transactionId: id("transaction").notNull(),
...
export const reward = convexTable(
  "reward",
  {
  ...
  (t) => [index("by_isActive").on(t.isActive)],
);

export const cart = convexTable(
  "cart",
  {
    employeeId: id("employee").notNull(),
...
export const cartItem = convexTable(
  "cartItem",
  {
...
export const redemption = convexTable(
  "redemption",
  {
    employeeId: id("employee").notNull(),
    rewardId: id("reward").notNull(),
...
export const review = convexTable(
  "review",
  {
...
export const activityParticipant = convexTable(
  "activityParticipant",
  {
...
export const activityLog = convexTable(
  "activityLog",
  {
...
export const redemptionSummary = convexTable(
  "redemptionSummary",
  {
...
export const k2Workflow = convexTable(
  "k2Workflow",
  {

...
function createProcedureRegistry() {
  ...
  "migrateLocalizedStrings": ["mutation", typedProcedureResolver(internal["activity"]["migrateLocalizedStrings"], () => (require("../activity") as Record<string, unknown>)["migrateLocalizedStrings"])],

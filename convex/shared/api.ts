...
export const api = {
  task: {
    create: createApiLeaf<"mutation", typeof import("../functions/task").create>(convexApi["task"]["create"], { type: "mutation" }),
    get: createApiLeaf<"query", typeof import("../functions/task").get>(convexApi["task"]["get"], { type: "query" }),
  },
  _http: {
  },
} as const;
